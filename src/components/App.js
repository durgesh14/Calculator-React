    ...
    switch (data) {
      ...
      case '=':
        try {
          ...
          // setValue(value); // sets the value to the answer
        } catch (error) {
    ...
    <div className={'calculator-body'}>
        <div className={'calculator-btns'}>
          <div className={'calculator-row1'}>
            <Buttons buttonName = 'C' onBtnClick={() => handleClick('C')} className="color-button"/>
            <Buttons buttonName = '+/-' onBtnClick={() => handleClick('+/-')} className="color-button"/>
            <Buttons buttonName = '%' onBtnClick={() => handleClick('%')} className="color-button" />
            <Buttons buttonName = '/' onBtnClick={() => handleClick('/')} className="color-button" />
          </div>
